...
import type { Bina as _Bina, DavetKodu as _DavetKodu, Role as _Role, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
